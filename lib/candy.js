(function(){
  ...
  Candy.prototype.becomeBomb = function(){
    this.$div.removeClass("candy-" + this.color + "-wrapped");
    this.$div.addClass("candy-bomb");
    this.color = "infinite";
  ...
  Candy.prototype.burstDestroy = function(){
    this.fireBurst();
    this.$div.remove();
  };
  ...
  Candy.prototype.fireBurst = function(){
    var posClass = "row-" + this.row + "-col-" + this.col;
    var $burstDiv = $("<div>").addClass("bomb-burst-effect-box").addClass(posClass);
    this.$div.after($burstDiv);
